...
final case class DateReMapper(sources: List[String], format: Option[String] = None) extends Processor
...
final case class MessageReMapper(sources: List[String])                             extends Processor
...
final case class ReMapper(sources: List[String], target: String, preserveSource: Boolean, overrideOnConflict: Boolean)
    extends Processor
